...
import { copyImageToClipboard, copyTextToClipboard } from '../../services/api'
            ...
            <div className="space-y-2">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white rounded-lg transition-colors ${
                  imageCopied ? 'bg-green-600' : 'bg-blue-600 hover:bg-blue-700'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white rounded-lg transition-colors ${
                  textCopied ? 'bg-green-600' : 'bg-green-600 hover:bg-green-700'
                }`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
                {textCopied ? 'Descripción copiada' : 'Copiar descripción'}
              </button>
